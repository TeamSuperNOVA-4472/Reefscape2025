...
public class VisionAlign {
    ...
    private final Transform2d kRightCoralL3Transform = new Transform2d(0.45, 0.25, Rotation2d.k180deg);
    private final Transform2d kRightCoralL4Transform = new Transform2d(0.45, 0.265, Rotation2d.k180deg);
