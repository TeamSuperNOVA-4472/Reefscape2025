...
public class VisionAlign {
    ...
    private final Transform2d kLeftCoralL4Transform = new Transform2d(0.425, -0.23, Rotation2d.k180deg); 
    ...
    private final Transform2d kRightCoralL4Transform = new Transform2d(0.425, 0.18, Rotation2d.k180deg);
