 ...
 */
public class SwitchPresetCommandOld extends SequentialCommandGroup
{
    public static SwitchPresetCommandOld stow(boolean keepAlive)
    {
        SwitchPresetCommandOld preset = new SwitchPresetCommandOld(true);
        preset.addCommands(
    ...
    public static SwitchPresetCommandOld load(boolean keepAlive)
    {
        SwitchPresetCommandOld preset = new SwitchPresetCommandOld(true);
        preset.addCommands(
    ...
    public SwitchPresetCommandOld(CarriagePreset newPreset, boolean keepAlive)
    {
        // Same thing as the other constructor but with a simple constant supplier.
        this(() -> newPreset, keepAlive);
    }
    public SwitchPresetCommandOld(Supplier<CarriagePreset> newPreset, boolean keepAlive)
    {
    ...
    private SwitchPresetCommandOld(boolean special) // Do custom constructor things. Nothing else.
    {
    ...
    private void init()
    {
        ...
        {
            System.err.println("[SWITCH] PLEASE DO NOT PASS A STOW OR A LOADING PRESET INTO THE SwitchPresetCommandOld CONSTRUCTOR!!! If you are stowing, call .stow(). If you are loading, call load().");
            cancel();
        }
