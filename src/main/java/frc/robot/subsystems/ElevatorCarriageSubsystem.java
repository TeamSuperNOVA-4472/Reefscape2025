...
public class ElevatorCarriageSubsystem extends SubsystemBase
{
    ...
    private static final double kElevatorKG = 0; // NOTE: The elevator appears to not need a kG. Changing this value above zero will do weird things to the switchpresetcommand.
