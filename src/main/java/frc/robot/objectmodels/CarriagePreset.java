...
public class CarriagePreset
{
    ...
    public static final CarriagePreset kCoralL2 = new CarriagePreset(89, -114, 15.816);
    public static final CarriagePreset kCoralL3 = new CarriagePreset(81, -122, 34.625, true);
    public static final CarriagePreset kCoralL4 = new CarriagePreset(108, -142, 61.23);
