...
public class CarriagePreset
{
    ...
    public static final CarriagePreset kCoralL4 = new CarriagePreset(100, -142, 60.125);
    public static final CarriagePreset kCoralLoad = new CarriagePreset(104, -71, 6);
    public static final CarriagePreset kStowCoral = new CarriagePreset(72, 18, 0); // Also used to be known as "moving" in some places of the code.
